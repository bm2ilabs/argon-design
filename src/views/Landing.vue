            ...
            <div class="row">
              <div class="col-lg-6">
                <h1 class="display-3  text-white">
                  Vue.js App
                  <span>Designed by Creative-Tim</span>
                </h1>
                <p class="lead  text-white">
                  This design system comes with four pre-built pages to help you get started faster.
                </p>
                <div class="btn-wrapper">
                  <a
                    target="_blank"
                    href="https://github.com/vue-theme/argon-design"
